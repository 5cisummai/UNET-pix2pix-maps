...
class PatchDiscriminator(nn.Module):
    ...
    def __init__(self, source_channels: int = 3, target_channels: int = 3, base_channels: int = 64, norm_type: str = "instance") -> None:
        super().__init__()
